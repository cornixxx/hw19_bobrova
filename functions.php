...
function themes_taxonomy() {
    register_taxonomy(
       'portfolio_categories',  //The name of the taxonomy. Name should be in slug form (must not contain capital letters or spaces).
        'portfolio_items',        //post type name
       array(
            'hierarchical' => true,
...
/*Contact form*/
function rex_form_process() {
	// do whatever you need in order to process the form.
}
add_action("wp_ajax_rex_form", "rex_form_process");

//use this version for if you want the callback to work for users who are not logged in
add_action("wp_ajax_nopriv_rex_form", "rex_form_process");
...
function _s_scripts() {
	...
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.css', array(), true );
	...
	wp_enqueue_script( 'slick', get_template_directory_uri() . '/js/slick.js', array('jquery'), '1.5.7', true );
	...
	wp_enqueue_script( 'jquery.mixitup', get_template_directory_uri() . '/js/jquery.mixitup.js', array('jquery'), '2.1.10', true );

	wp_enqueue_script( 'jquery.fancybox.pack', get_template_directory_uri() . '/js/jquery.fancybox.pack.js', array('jquery'), '2.1.5', true );
